...
weights_file = os.path.join(WEIGHTS_DIR, 'prednet_kitti_weights_teste_pc.hdf5')  # where weights will be saved
json_file = os.path.join(WEIGHTS_DIR, 'prednet_kitti_model_teste_pc.json')
